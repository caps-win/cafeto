...
namespace CafetoTest
{
    public class JobLogger
    {
        ...
        private static IDestination _destinationConfig;
        ...
        public JobLogger(IDestination destinationConfig)
        {
        ...
        public static void LogMessage(string message, MessageType messageType)
        {
            try
            {
                StrategyMessage strategyMessage = new StrategyMessage(_destinationConfig);
                strategyMessage.writeMessage(message, messageType);
            }
            catch (Exception ex)
            {
